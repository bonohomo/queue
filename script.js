...
// localStorage.user = JSON.stringify({name: "Сергей"}); // ОБЪЕКТ JS ПРЕОБРАЗОВЫВАЕМ В JSON ОБЪЕКТ (это строка)
// let user = JSON.parse(localStorage.user) //  возвращает  json объект в js 
// console.log(user.name);

// localStorage.removeItem("username"); // удалить данные

// console.log(localStorage.clear()); // очистить куки


// КЛИКЕР С СОХРАНЕНИЕМ ДАННЫХ
...
//     })
// )
// console.log(sessionStorage.getItem("user")); // получаем в виде строки
// console.log("user:", JSON.parse(sessionStorage.getItem("user"))); // так получим данные нормально
